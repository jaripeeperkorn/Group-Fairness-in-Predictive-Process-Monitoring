...
def do_full_experiment(dataset_name, logname, max_prefix_length, addendum):
    ...
    for sensitive in binarys:
        ...
        plot_filename = f"Results/Experiment1_full_results_with_removal/figs/{logname}_{addendum}_{sensitive}_plot.pdf"
    ...
    output_path = f"Results/Experiment1_full_results_with_removal/{logname}_{addendum}_sensitive_evaluation_results.csv"
