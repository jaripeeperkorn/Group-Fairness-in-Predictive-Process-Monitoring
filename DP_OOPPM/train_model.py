...
def train_and_return_LSTM(X_train, y_train, s_train, loss_function, 
    ...
    train_loader, val_loader = prepare_data_loaders(X_train, y_train, s_train, X_val, y_val, s_val, batch_size)
    ...
    X_train, y_train, s_train = X_train.to(device), y_train.to(device), s_train.to(device)
...
def prepare_data_loaders(X_train, y_train, s_train, X_val, y_val, s_val, batch_size):
